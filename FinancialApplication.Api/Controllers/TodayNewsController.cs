...
namespace FinancialApplication.Api.Controllers
{
    ...
    public class TodayNewsController : ControllerBase
    {
        ...
        public TodayNewsController(AppDbContext dbContext, IMemoryCache cache)
        {
            ...
            [FromQuery] string? search = null)
        {
            ...
            if (!_cache.TryGetValue(NewsCacheWarmupService.TodayNewsCacheKey, out CachedNewsData? cachedData) || cachedData == null)
            {
        ...
        /// <summary>
        /// Clears the news cache and reloads fresh data from DB immediately.
        /// Call this after the NewsDataUpdateService finishes inserting new articles.
        /// </summary>
        [HttpPost("refresh")]
        public async Task<IActionResult> RefreshCache()
        {
            _cache.Remove(NewsCacheWarmupService.TodayNewsCacheKey);
        ...
        private async Task<CachedNewsData?> LoadAndCacheAsync()
        {
            ...
            _cache.Set(NewsCacheWarmupService.TodayNewsCacheKey, data, NewsCacheWarmupService.CacheDuration);
            return data;
        }
